 ...
 */
typedef bool (*split_call_t)(double t, const double *x, double last_t, const double *last_x, const double weight);
 ...
 * @param this_weights Weights of the particle at each observation time
 * @param weight Start weight of this particle. Will be updated to contain
...
int integration_loop(std::vector<Eigen::VectorXd>& observations, double *t, 
        ...
        double *weight, const std::string& scheme_name);
