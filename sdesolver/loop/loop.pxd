...
cdef extern from "loop.h":
    ...
    cdef int integration_loop (vector[VectorXd]& observations, double *t, Map[VectorXd]& x,
                     ...
                     vector[VectorXd]& split_times, vector[VectorXd]& split_points, vector[VectorXd]& split_weights, vector[VectorXd]& this_weights, double *weight, string scheme_name) nogil
    ...
    cdef int integration_loop_p (double *observations, int *observation_count, double *t, Map[VectorXd]& x,
                      ...
                      double **split_times, double **split_points, double **split_weights, double *this_weights, double *weight, string scheme_name) nogil
